            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        ...
                        <a href="{{route('public.commande')}}#commande" class="template-btn mt-3">passer votre commande</a>
                    </div>
                </div>
            </div>
        </div>
       ...
       <section class="food-area section-padding">
        <div class="container">
            ...
            <div class="table-btn text-center">
                <a href="{{route('public.commande')}}#commande" class=" a template-btn m-5 text-md-center">passer votre commande</a> 
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="{{route('public.commande')}}#commande" class="genric-btn primary radius"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">PASSER VOTRE COMMANDE</font></font></a>
                </div>
            </div>
        </div>
    </div>
