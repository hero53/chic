              ...
              <div class="col-md-3">
                  <div class="single-widget single-widget2 my-5 my-md-0">
                      ...
                      <div class="d-flex">
                          ...
                          <div class="info-text">
                              <p>(+225) 57559041 / 01616551 / 88860757</p>
                          </div>
                      </div>
                      <div class="d-flex">
                          <div class="into-icon">
          ...
          <div class="row">
              ...
              <div class="col-lg-5 col-md-6">
                  <div class="social-icons">
                      <ul>
                          <li class="no-margin">Suivez nous </li>
                          <li><a href="https://www.facebook.com/Poulet-chic-102761704453630/" target="_blank"><i class="fa fa-facebook"></i></a></li>
